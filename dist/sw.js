const CACHE = 'onebox-v326';
const APP_SHELL = [
  './',
  'index.html',
  'style.css?v=2.18.307',
  'app.js?v=2.18.307',
  'calendar-data.js?v=2.18.307',
  'manifest.webmanifest',
  'manifest.webmanifest?v=2.18.307',
  'favicon.ico',
  ...
  'icons/mascot-fox-full-reactions.png?v=2.18.307',
  'icons/mascot-fox-full.png',
  'icons/mascot-fox-full.png?v=2.18.307',
  'icons/bell.svg',
  'icons/bell-192.png',
  'icons/weibo.png',
  'icons/guancha.png?v=2.18.307',
  'icons/ithome.svg',
  'icons/ithome.svg?v=2.18.307',
  'icons/bilibili.ico',
  'icons/bilibili.ico?v=2.18.307',
  'icons/bilibili.svg',
  'icons/bilibili.svg?v=2.18.307',
  'icons/hupu.ico',
  'icons/hupu.ico?v=2.18.307',
];
