const CACHE = 'onebox-v159';
const APP_SHELL = ['./', 'index.html', 'style.css?v=2.18.111', 'app.js?v=2.18.111', 'calendar-data.js?v=2.18.111', 'manifest.webmanifest', 'icons/icon.svg', 'icons/icon-180.png', 'icons/icon-192.png', 'icons/icon-512.png', 'icons/icon-dark-180.png', 'icons/icon-dark-192.png', 'icons/icon-dark-512.png', 'icons/bell.svg', 'icons/bell-192.png', 'icons/weibo.png', 'icons/guancha.png?v=2.18.111', 'icons/bilibili.svg'];
