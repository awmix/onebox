const CACHE = 'onebox-v335';
const APP_SHELL = [
  './',
  'index.html',
  'style.css?v=2.18.316',
  'app.js?v=2.18.316',
  'calendar-data.js?v=2.18.316',
  'manifest.webmanifest',
  'manifest.webmanifest?v=2.18.316',
  'favicon.ico',
  'favicon.ico?v=2.18.316',
  'apple-touch-icon.png',
  'apple-touch-icon-precomposed.png',
  'apple-touch-icon.png?v=2.18.316',
  'favicon-v313.svg?v=2.18.316',
  'favicon-v313.ico?v=2.18.316',
  'icons/onebox-brand-v313-16.png?v=2.18.316',
  'icons/onebox-brand-v313-32.png?v=2.18.316',
  'icons/onebox-brand-v313-48.png?v=2.18.316',
  'icons/onebox-brand-v313-64.png?v=2.18.316',
  'icons/onebox-brand-v313-128.png?v=2.18.316',
  'icons/onebox-brand-v313-120.png?v=2.18.316',
  'icons/onebox-brand-v313-152.png?v=2.18.316',
  'icons/onebox-brand-v313-167.png?v=2.18.316',
  'icons/onebox-brand-v313-180.png?v=2.18.316',
  'icons/onebox-brand-v313-192.png?v=2.18.316',
  'icons/onebox-brand-v313-256.png?v=2.18.316',
  'icons/onebox-brand-v313-512.png?v=2.18.316',
  'icons/onebox-brand-v313-1024.png?v=2.18.316',
