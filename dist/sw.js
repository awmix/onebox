const CACHE = 'onebox-v325';
const APP_SHELL = [
  './',
  'index.html',
  'style.css?v=2.18.306',
  'app.js?v=2.18.306',
  'calendar-data.js?v=2.18.306',
  'manifest.webmanifest',
  'manifest.webmanifest?v=2.18.306',
  'favicon-black-v306.ico',
  'favicon-black-v306-64.png',
  'favicon-black-v306-192.png',
  'apple-touch-icon-black-v306-180.png',
  'apple-touch-icon-black-v306-192.png',
  'icons/icon-black-v306-192.png',
  'icons/icon-black-v306-512.png',
  'icons/icon-black-v306-1024.png',
  'icons/mascot-fox-full-reactions.png',
  'icons/mascot-fox-full-reactions.png?v=2.18.306',
  'icons/mascot-fox-full.png',
  'icons/mascot-fox-full.png?v=2.18.306',
  'icons/bell.svg',
  'icons/bell-192.png',
  'icons/weibo.png',
  'icons/guancha.png?v=2.18.306',
  'icons/ithome.svg',
  'icons/ithome.svg?v=2.18.306',
  'icons/bilibili.ico',
  'icons/bilibili.ico?v=2.18.306',
  'icons/bilibili.svg',
  'icons/bilibili.svg?v=2.18.306',
  'icons/hupu.ico',
  'icons/hupu.ico?v=2.18.306',
];
