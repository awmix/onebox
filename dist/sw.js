...
const APP_SHELL = [
  './',
  'index.html',
  'style.css?v=2.18.346',
  'app.js?v=2.18.346',
  'calendar-data.js?v=2.18.346',
  'manifest.webmanifest',
  'manifest.webmanifest?v=2.18.346',
  'favicon-v317.ico?v=2.18.346',
  'apple-touch-icon.png',
  'apple-touch-icon-precomposed.png',
  'apple-touch-icon.png?v=2.18.346',
  'icons/onebox-brand-v317-16.png?v=2.18.346',
  'icons/onebox-brand-v317-32.png?v=2.18.346',
  'icons/onebox-brand-v317-48.png?v=2.18.346',
  'icons/onebox-brand-v317-64.png?v=2.18.346',
  'icons/onebox-brand-v317-128.png?v=2.18.346',
  'icons/onebox-brand-v317-120.png?v=2.18.346',
  'icons/onebox-brand-v317-152.png?v=2.18.346',
  'icons/onebox-brand-v317-167.png?v=2.18.346',
  'icons/onebox-brand-v317-180.png?v=2.18.346',
  'icons/onebox-brand-v317-192.png?v=2.18.346',
  'icons/onebox-brand-v317-256.png?v=2.18.346',
  'icons/onebox-brand-v317-512.png?v=2.18.346',
  'icons/onebox-brand-v317-1024.png?v=2.18.346',
