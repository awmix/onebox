const CACHE = 'onebox-v329';
const APP_SHELL = [
  './',
  'index.html',
  'style.css?v=2.18.310',
  'app.js?v=2.18.310',
  'calendar-data.js?v=2.18.310',
  'manifest.webmanifest',
  'manifest.webmanifest?v=2.18.310',
  'favicon.ico',
  'apple-touch-icon.png',
  'apple-touch-icon-precomposed.png',
  'favicon-black-v307.ico',
  'favicon-black-v307-64.png',
  'favicon-black-v307-192.png',
  'apple-touch-icon-black-v307-180.png',
  'apple-touch-icon-black-v307-192.png',
  'favicon-v299.svg?v=2.18.310',
  'favicon-v299-512.png?v=2.18.310',
  'favicon-v299.ico?v=2.18.310',
  'icons/icon-black-v307-192.png',
  'icons/icon-black-v307-512.png',
  'icons/icon-black-v307-1024.png',
  'icons/mascot-fox-full-reactions.png',
  'icons/mascot-fox-full-reactions.png?v=2.18.310',
  'icons/mascot-fox-full.png',
  'icons/mascot-fox-full.png?v=2.18.310',
  'icons/bell.svg',
  'icons/bell-192.png',
  'icons/weibo.png',
  'icons/guancha.png?v=2.18.310',
  'icons/ithome.svg',
  'icons/ithome.svg?v=2.18.310',
  'icons/bilibili.ico',
  'icons/bilibili.ico?v=2.18.310',
  'icons/bilibili.svg',
  'icons/bilibili.svg?v=2.18.310',
  'icons/hupu.ico',
  'icons/hupu.ico?v=2.18.310',
];
