const CACHE = 'onebox-v330';
const APP_SHELL = [
  './',
  'index.html',
  'style.css?v=2.18.311',
  'app.js?v=2.18.311',
  'calendar-data.js?v=2.18.311',
  'manifest.webmanifest',
  'manifest.webmanifest?v=2.18.311',
  'favicon.ico',
  ...
  'favicon-v299.svg?v=2.18.311',
  'favicon-v299-512.png?v=2.18.311',
  'favicon-v299.ico?v=2.18.311',
