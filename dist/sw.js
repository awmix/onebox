const CACHE = 'onebox-v216';
const APP_SHELL = ['./', 'index.html', 'style.css?v=2.18.186', 'app.js?v=2.18.186', 'calendar-data.js?v=2.18.186', 'manifest.webmanifest', 'icons/icon.svg', 'icons/icon.svg?v=2.18.186', 'icons/icon-180.png', 'icons/icon-192.png', 'icons/icon-512.png', 'icons/icon-dark-180.png', 'icons/icon-dark-192.png', 'icons/icon-dark-512.png', 'icons/favicon-light-64.png', 'icons/favicon-light-64.png?v=2.18.186', 'icons/favicon-dark-64.png', 'icons/favicon-dark-64.png?v=2.18.186', 'apple-touch-icon.png', 'apple-touch-icon.png?v=2.18.186', 'apple-touch-icon-dark.png', 'apple-touch-icon-dark.png?v=2.18.186', 'icons/apple-touch-icon.png', 'icons/apple-touch-icon.png?v=2.18.186', 'icons/apple-touch-icon-dark.png', 'icons/apple-touch-icon-dark.png?v=2.18.186', 'icons/bell.svg', 'icons/bell-192.png', 'icons/weibo.png', 'icons/guancha.png?v=2.18.186', 'icons/ithome.svg', 'icons/ithome.svg?v=2.18.186', 'icons/bilibili.ico', 'icons/bilibili.ico?v=2.18.186', 'icons/hupu.ico', 'icons/hupu.ico?v=2.18.186'];
