const CACHE = 'onebox-v97';
const APP_SHELL = ['./', 'index.html', 'style.css?v=2.18.51.1', 'app.js?v=2.18.51.1', 'calendar-data.js?v=2.18.51.1', 'manifest.webmanifest', 'icons/icon.svg', 'icons/icon-180.png', 'icons/icon-192.png', 'icons/icon-512.png', 'icons/icon-dark-180.png', 'icons/icon-dark-192.png', 'icons/icon-dark-512.png', 'icons/bell.svg', 'icons/bell-192.png'];
