const CACHE = 'onebox-v327';
const APP_SHELL = [
  './',
  'index.html',
  'style.css?v=2.18.308',
  'app.js?v=2.18.308',
  'calendar-data.js?v=2.18.308',
  'manifest.webmanifest',
  'manifest.webmanifest?v=2.18.308',
  'favicon.ico',
  ...
  'icons/mascot-fox-full-reactions.png?v=2.18.308',
  'icons/mascot-fox-full.png',
  'icons/mascot-fox-full.png?v=2.18.308',
  'icons/bell.svg',
  'icons/bell-192.png',
  'icons/weibo.png',
  'icons/guancha.png?v=2.18.308',
  'icons/ithome.svg',
  'icons/ithome.svg?v=2.18.308',
  'icons/bilibili.ico',
  'icons/bilibili.ico?v=2.18.308',
  'icons/bilibili.svg',
  'icons/bilibili.svg?v=2.18.308',
  'icons/hupu.ico',
  'icons/hupu.ico?v=2.18.308',
];
