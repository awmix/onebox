const CACHE = 'onebox-v324';
const APP_SHELL = [
  './',
  'index.html',
  'style.css?v=2.18.305',
  'app.js?v=2.18.305',
  'calendar-data.js?v=2.18.305',
  'manifest.webmanifest',
  'manifest.webmanifest?v=2.18.305',
  'favicon-black-v305.ico',
  'favicon-black-v305-64.png',
  'favicon-black-v305-192.png',
  'apple-touch-icon-black-v305-180.png',
  'apple-touch-icon-black-v305-192.png',
  'icons/icon-black-v305-192.png',
  'icons/icon-black-v305-512.png',
  'icons/icon-black-v305-1024.png',
  'icons/mascot-fox-full-reactions.png',
  'icons/mascot-fox-full-reactions.png?v=2.18.305',
  'icons/mascot-fox-full.png',
  'icons/mascot-fox-full.png?v=2.18.305',
  'icons/bell.svg',
  'icons/bell-192.png',
  'icons/weibo.png',
  'icons/guancha.png?v=2.18.305',
  'icons/ithome.svg',
  'icons/ithome.svg?v=2.18.305',
  'icons/bilibili.ico',
  'icons/bilibili.ico?v=2.18.305',
  'icons/bilibili.svg',
  'icons/bilibili.svg?v=2.18.305',
  'icons/hupu.ico',
  'icons/hupu.ico?v=2.18.305',
];
