...
const DICT = {
  zh: {
    ...
    appUpdate: '应用更新', checkUpdate: '检查', updateAvailable: '发现有新版本', upToDate: '已是最新版', updating: '检查中', updateApplying: '更新中', updateCheckFailed: '检查失败，可重试', applyUpdate: '更新',
  ...
  en: {
    ...
    appUpdate: 'App update', checkUpdate: 'Check', updateAvailable: 'A new version is available', upToDate: 'Latest version', updating: 'Checking', updateApplying: 'Updating', updateCheckFailed: 'Check failed. Try again.', applyUpdate: 'Update',
