...
function navigationIconSources(value) {
  ...
  try {
    ...
    if (navigationUsesOneBoxBrandIcon(url)) return [navigationAppAssetUrl('favicon-black-v305-192.png'), navigationAppAssetUrl('apple-touch-icon-black-v305-192.png'), navigationAppAssetUrl('icons/icon-black-v305-512.png')];
