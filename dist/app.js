...
function navigationIconSources(value) {
  ...
  try {
    ...
    if (navigationUsesOneBoxBrandIcon(url)) return [navigationAppAssetUrl('icons/onebox-brand-v312-192.png?v=2.18.312'), navigationAppAssetUrl('icons/onebox-brand-v312-512.png?v=2.18.312')];
