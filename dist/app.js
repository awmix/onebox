...
function navigationIconSources(value) {
  ...
  try {
    ...
    if (navigationUsesOneBoxBrandIcon(url)) return [navigationAppAssetUrl('icons/onebox-brand-v313-192.png?v=2.18.316'), navigationAppAssetUrl('icons/onebox-brand-v313-512.png?v=2.18.316')];
