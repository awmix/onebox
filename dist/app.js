...
function renderLunarDialog(key) {
  ...
  const almanacFields = isEnglish ? [
    ['Zodiac', almanac.zodiac], ['Constellation', constellation.en], ['Year element', almanac.yearElement], ['Peng Zu taboos', almanac.pengZu, true], ['Fetal deity', almanac.fetalPalace, true], ['Season', almanac.season], ['Month pillar', almanac.monthPillar], ['Month element', almanac.monthElement], ['Mansion', almanac.mansion], ['Day element', almanac.dayElement], ['Solar term', almanac.solarTerm, true], ['Julian day', almanac.julian], ['Buddhist year', almanac.buddhist], ['Islamic date', almanac.islamic], ['Clash', almanac.clash], ['Sha direction', almanac.sha], ['Six star', almanac.sixStar], ['Twelve duty', almanac.twelveGod],
  ] : [
    ['生肖', almanac.zodiac], ['星座', constellation.zh], ['年五行', almanac.yearElement], ['彭祖百忌', almanac.pengZu, true], ['胎神占方', almanac.fetalPalace, true], ['季节', almanac.season], ['月柱', almanac.monthPillar + '月'], ['月五行', almanac.monthElement], ['星宿', almanac.mansion], ['日五行', almanac.dayElement], ['节气', almanac.solarTerm, true], ['儒略日', almanac.julian], ['佛历年', almanac.buddhist], ['伊斯兰历', almanac.islamic], ['冲', almanac.clash], ['煞', almanac.sha], ['六曜', almanac.sixStar], ['十二神', almanac.twelveGod],
  ];
