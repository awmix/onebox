...
function readerReadingView(book) {
  ...
  return '<div class="reader-reference-shell' + chromeClass + '" data-reader-theme="' + escapeHtml(state.readerPreferences.theme) + '">' +
    ...
    '<footer class="reader-reference-bottom"><div class="reader-reference-progress-line" data-reader-progress-line role="progressbar" aria-label="' + t('readerProgress') + '" aria-valuemin="0" aria-valuemax="100" aria-valuenow="0"><span class="reader-reference-progress-track"><i data-reader-progress-fill></i></span><span class="reader-reference-progress-meta"><b data-reader-progress-label>0%</b><em>|</em><b data-reader-page-info>—</b></span></div><div class="reader-reference-chapter"><span class="reader-reference-chapter-name" data-reader-chapter-name>' + escapeHtml(chapter) + '</span></div>' +
...
function reader() {
  ...
  return '<div class="reader-library-view"><section class="reader-library-panel"><div class="reader-library-head"><div class="reader-library-title-row"><h2>' + t('bookshelf') + '</h2><small>' + t('readerHint') + '</small></div><div class="reader-library-actions"><span class="reader-book-count" aria-label="' + books.length + '" title="' + books.length + '">' + books.length + '</span><button class="reader-layout-toggle" data-reader-layout-toggle aria-label="切换书架布局">' + layoutIcon + '</button></div></div>' + libraryBody + '</section><input id="readerFileInput" type="file" hidden multiple accept=".md,.markdown,.txt,.pdf,.epub,text/markdown,text/plain,application/pdf,application/epub+zip"></div>';
}
